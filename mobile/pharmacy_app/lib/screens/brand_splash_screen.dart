...
///
/// Uses the new purple brand mark deliberately — this is the app-icon/brand
/// identity moment only. PharmacyTheme (lib/theme.dart) stays green for the
/// actual in-app UI, per the planning doc's "Pharmacy module -> green"
/// requirement; this splash isn't a repaint of that.
...
class _BrandSplashScreenState extends State<BrandSplashScreen>
  ...
  static const _bg = Color(0xFFECDBFD);
  static const _dark = Color(0xFF3B0764);
            ...
            AnimatedBuilder(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Medicines for a Healthier Tomorrow',
