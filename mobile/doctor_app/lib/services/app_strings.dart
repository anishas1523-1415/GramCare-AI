...
const Map<String, String> _en = {
  ...
  'referrals_none_sent': "Referrals you've sent will appear here.",
  'referrals_load_failed': 'Could not load referrals.',
  'referral_action_failed': 'Could not update this referral.',
  'referral_open_note': 'Open referral — accepting claims it',
  'patient': 'Patient',
  'accept': 'Accept',
  'decline': 'Decline',
  ...
  'sos_status': 'Status',
  'navigate_to_patient': 'Navigate to patient',
  'sos_voice_play': "Play patient's recording",
  'sos_voice_stop': 'Stop',
  'sos_voice_play_failed': 'Could not play the recording.',
...
const Map<String, String> _ta = {
  ...
  'referrals_none_sent': 'நீங்கள் அனுப்பிய பரிந்துரைகள் இங்கே தோன்றும்.',
  'referrals_load_failed': 'பரிந்துரைகளை ஏற்ற முடியவில்லை.',
  'referral_action_failed': 'இந்த பரிந்துரையைப் புதுப்பிக்க முடியவில்லை.',
  'referral_open_note': 'திறந்த பரிந்துரை — ஏற்றுக்கொண்டால் உங்களுடையதாகும்',
  'patient': 'நோயாளி',
  'accept': 'ஏற்றுக்கொள்',
  'decline': 'நிராகரி',
  'mark_complete': 'முடிந்ததாகக் குறி',
  ...
  'sos_location': 'இடம்',
  'sos_status': 'நிலை',
  'navigate_to_patient': 'நோயாளியிடம் செல்லவும்',
  'sos_voice_play': 'நோயாளியின் பதிவைக் கேட்க',
  'sos_voice_stop': 'நிறுத்து',
  'sos_voice_play_failed': 'பதிவை இயக்க முடியவில்லை.',
