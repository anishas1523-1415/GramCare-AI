                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return Card(
                            ...
                            color: PharmacyTheme.statusLow.withValues(alpha: 0.08),
                            child: ListTile(
                              leading: const Icon(Icons.warning_amber_rounded, color: PharmacyTheme.statusLow),
                              ...
                              trailing: item.daysLeft != null
                                  ? Text('${item.daysLeft} ${locale.t('days_left')}',
                                      style: const TextStyle(color: PharmacyTheme.statusLow, fontWeight: FontWeight.bold))
                                  : null,
                            ),
                          );
                        },
